...
const Page = ({ data }) => {
  ...
  const handleClickTrack = async (product, buttonName) => {
    try {
      ...
      const response = await fetch('https://backend.thirstymaart.com/api/analysis/track-click', {
        method: 'POST',
        headers: {
  ...
  const fetchCategory = async () => {
    try {
      const response = await fetch('https://backend.thirstymaart.com/api/categories/trending');
      if (!response.ok) {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('https://backend.thirstymaart.com/api/products/list');
      if (!response.ok) {
