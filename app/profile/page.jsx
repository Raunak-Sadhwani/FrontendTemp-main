    ...
    useEffect(() => {
        ...
        const fetchVendorInfo = async () => {
            try {
                ...
                const response = await fetch('https://backend.thirstymaart.com/api/vendorinfo/get', {
                    method: 'GET',
                    headers: {
        ...
        const fetchVendorProducts = async () => {
            try {
                ...
                const response = await fetch('https://backend.thirstymaart.com/api/products/vendorproducts', {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${Token}`,
